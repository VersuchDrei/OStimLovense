...
namespace AutoTOML {
    ...
    public:
        ...
        ISetting(string_t a_group, string_t a_key) : _group(std::move(a_group)), _key(std::move(a_key)) {
    ...
    namespace detail {
        template <class T, toml::node_type E>
        class tSetting : public ISetting {
        private:
        ...
        public:
            ...
            tSetting(string_t a_group, string_t a_key, value_type a_value)
                : super(std::move(a_group), std::move(a_key)), _value(std::move(a_value)) {}
            ...
            template <class U = value_type, std::enable_if_t<std::is_class_v<U>, int> = 0>
